...
* localhost:
* mongo DB_NAME scripts/init.mongo.js
* Atlas:
* mongo mongodb+srv://user:pwd@xxx.mongodb.net/DB_NAME 
scripts/init.mongo.js
* MLab:
* mongo mongodb://user:pwd@xxx.mlab.com:33533/DB_NAME 
scripts/init.mongo.js
*/
...
const whc = [
  {
    ...
    short_description: '<p><span>This transboundary property stretches over 12 countries. Since the end of the last Ice Age, European Beech spread from a few isolated refuge areas in the Alps, Carpathians</span><span>, Dinarides</span><span>, Mediterranean and Pyrenees over a short period of a few thousand years in a process that is still ongoing. The successful expansion across a whole continent is related to the tree’s </span><span>adaptability and tolerance of different climatic, geographical and physical conditions. </span></p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>Chosen from the work of Le Corbusier, the 17 sites comprising this transnational serial property are spread over seven countries and are a testimonial to the invention of a new architectural language that made a break with the past. They were built over a period of a half-century, in the course of what Le Corbusier described as “patient research”. The Complexe du Capitole in Chandigarh (India), the National Museum of Western Art, Tokyo (Japan), the House of Dr Curutchet in La Plata (Argentina) and the Unité d’habitation in Marseille (France) reflect the solutions that the Modern Movement sought to apply during the 20th century to the challenges of inventing new architectural techniques to respond to the needs of society. These masterpieces of creative genius also attest to the internationalization of architectural practice across the planet.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>This site is an extensive Inca communication, trade and defence network of roads covering 30,000 km. Constructed by the Incas over several centuries and partly based on pre-Inca infrastructure, this extraordinary network through one of the world’s most extreme geographical terrains linked the snow-capped peaks of the Andes – at an altitude of more than 6,000 m – to the coast, running through hot rainforests, fertile valleys and absolute deserts. It reached its maximum expansion in the 15th century, when it spread across the length and breadth of the Andes. The Qhapac Ñan, Andean Road System includes 273 component sites spread over more than 6,000 km that were selected to highlight the social, political, architectural and engineering achievements of the network, along with its associated infrastructure for trade, accommodation and storage, as well as sites of religious significance.</p>\r\n<p><span> </span></p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>The transnational property is located in the Tien-Shan mountain system, one of the largest mountain ranges in the world. Western Tien-Shan ranges in altitude from 700 to 4,503 m. It features diverse landscapes, which are home to exceptionally rich biodiversity. It is of global importance as a centre of origin for a number of cultivated fruit crops and is home to a great diversity of forest types and unique plant community associations. </p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>The Uvs Nuur Basin (1,068,853 ha), is the northernmost of the enclosed basins of Central Asia. It takes its name from Uvs Nuur Lake, a large, shallow and very saline lake, important for migrating birds, waterfowl and seabirds. The site is made up of twelve protected areas representing the major biomes of eastern Eurasia. The steppe ecosystem supports a rich diversity of birds and the desert is home to a number of rare gerbil, jerboas and the marbled polecat. The mountains are an important refuge for the globally endangered snow leopard, mountain sheep (argali) and the Asiatic ibex.</p>',
    site: 'Uvs Nuur Basin',
  ...
  },
  {
    ...
    revision: '1',
    secondary_dates: '',
    short_description: '<p>Heard Island and McDonald Islands are located in the Southern Ocean, approximately 1,700 km from the Antarctic continent and 4,100 km south-west of Perth. As the only volcanically active subantarctic islands they &lsquo;open a window into the earth&rsquo;, thus providing the opportunity to observe ongoing geomorphic processes and glacial dynamics. The distinctive conservation value of Heard and McDonald &ndash; one of the world&rsquo;s rare pristine island ecosystems &ndash; lies in the complete absence of alien plants and animals, as well as human impact.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>This park is one of the last major remnants of the primary tropical forest of West Africa. Its rich natural flora, and threatened mammal species such as the pygmy hippopotamus and 11 species of monkeys, are of great scientific interest.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>One of the largest protected areas in West Africa, this park is characterized by its great plant diversity. Due to the presence of the Comoé river, it contains plants which are normally only found much farther south, such as shrub savannahs and patches of thick rainforest.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>The ruins of Diocletian\'s Palace, built between the late 3rd and the early 4th centuries A.D., can be found throughout the city. The cathedral was built in the Middle Ages, reusing materials from the ancient mausoleum. Twelfth- and 13th-century Romanesque churches, medieval fortifications, 15th-century Gothic palaces and other palaces in Renaissance and Baroque style make up the rest of the protected area.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>Trogir is a remarkable example of urban continuity. The orthogonal street plan of this island settlement dates back to the Hellenistic period and it was embellished by successive rulers with many fine public and domestic buildings and fortifications. Its beautiful Romanesque churches are complemented by the outstanding Renaissance and Baroque buildings from the Venetian period.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>The Cathedral of St James in &Scaron;ibenik (1431-1535), on the Dalmatian coast, bears witness to the considerable exchanges in the field of monumental arts between Northern Italy, Dalmatia and Tuscany in the 15th and 16th centuries. The three architects who succeeded one another in the construction of the Cathedral - Francesco di Giacomo, Georgius Mathei Dalmaticus and Niccol&ograve; di Giovanni Fiorentino - developed a structure built entirely from stone and using unique construction techniques for the vaulting and the dome of the Cathedral. The form and the decorative elements of the Cathedral, such as a remarkable frieze decorated with 71 sculptured faces of men, women, and children, also illustrate the successful fusion of Gothic and Renaissance art.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>A vast area of primary tropical forest dominated by two spectacular extinct volcanoes, Kahuzi and Biega, the park has a diverse and abundant fauna. One of the last groups of eastern lowland (graueri) gorillas (consisting of only some 250 individuals) lives at between 2,100 and 2,400 m above sea-level.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>The capital of the Old Kingdom of Egypt has some extraordinary funerary monuments, including rock tombs, ornate mastabas, temples and pyramids. In ancient times, the site was considered one of the Seven Wonders of the World.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>This outstanding archaeological area contains such magnificent monuments as the Temples of Ramses II at Abu Simbel and the Sanctuary of Isis at Philae, which were saved from the rising waters of the Nile thanks to the International Campaign launched by UNESCO, in 1960 to 1980.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>Tucked away amid the modern urban area of Cairo lies one of the world\'s oldest Islamic cities, with its famous mosques, <em>madrasas, hammams</em> and fountains. Founded in the 10th century, it became the new centre of the Islamic world, reaching its golden age in the 14th century.</p>',
    site: 'Historic Cairo',
    states: 'Egypt',
    transboundary: '0',
    unique_number: '95',
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>The church, baptistry, basilicas, public buildings, streets, monasteries, houses and workshops in this early Christian holy city were built over the tomb of the martyr Menas of Alexandria, who died in A.D. 296.</p>',
    site: 'Abu Mena',
    states: 'Egypt',
    transboundary: '0',
    unique_number: '96',
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>The Orthodox Monastery of St Catherine stands at the foot of Mount Horeb where, the Old Testament records, Moses received the Tablets of the Law. The mountain is known and revered by Muslims as Jebel Musa. The entire area is sacred to three world religions: Christianity, Islam, and Judaism. The Monastery, founded in the 6th century, is the oldest Christian monastery still in use for its initial function. Its walls and buildings of great significace to studies of Byzantine architecture and the Monastery houses outstanding collections of early Christian manuscripts and icons. The rugged mountainous landscape, containing numerous archaeological and religious sites and monuments, forms a perfect backdrop to the Monastery.</p>',
  ...
  },
  {
    ...
    revision: '0',
    secondary_dates: '',
    short_description: '<p>Joya de Cer&eacute;n was a pre-Hispanic farming community that, like Pompeii and Herculaneum in Italy, was buried under an eruption of the Laguna Caldera volcano c. AD 600. Because of the exceptional condition of the remains, they provide an insight into the daily lives of the Central American populations who worked the land at that time.</p>',
...
whc.forEach((wh) => {
  const place = {
    ...
    world_heritage_list: {
      ...
      criteria_txt: wh.criteria_txt,
      danger: wh.danger,
      date_inscribed: wh.date_inscribed,
      extension: wh.extension,
      http_url: wh.http_url,
      id_number: wh.id_number,
      image_url: wh.image_url,
      iso_code: wh.iso_code,
      justification: wh.justification,
      latitude: wh.latitude,
      location: wh.location,
      longitude: wh.longitude,
      region: wh.region,
      revision: wh.revision,
      secondary_dates: wh.secondary_dates,
      short_description: wh.short_description,
      site: wh.site,
      states: wh.states,
      transboundary: wh.transboundary,
      unique_number: wh.unique_number,
    },
  };
  placesDB.push(place);
});
